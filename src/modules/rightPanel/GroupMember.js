        ...
        if (openId == null || groupMember == null)
            ...
            return (
                <div className="group_user" style={{
                    ...
                    <div className="text-center message-box"><button className="btn_message m-t-lg" type="button" name="message" onClick={() => showMessage({ openId, isGroup: 1 })}>发消息</button></div>
                </div>
